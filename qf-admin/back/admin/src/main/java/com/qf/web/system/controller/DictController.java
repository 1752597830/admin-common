...
public class DictController extends BaseController {
    ...
    public BaseResponse getDictValuePage(@PathVariable String code) {
        startPage();
    ...
    public BaseResponse saveDictType(@RequestBody DictTypeForm dictTypeForm) {
        return isOk(dictTypeService.saveDictType(dictTypeForm));
    }

    @Operation(summary = "修改字典类型")
    @PutMapping("/type/{typeId}")
    public BaseResponse updateDictType(@PathVariable Long typeId, @RequestBody DictTypeForm dictTypeForm) {
        return isOk(dictTypeService.updateDictType(typeId, dictTypeForm));
    }

    @Operation(summary = "删除字典类型",description = "根据typeId删除对应字典类型")
    @DeleteMapping("/type/{typeId}")
    public BaseResponse deleteDictType(@PathVariable Long typeId) {
